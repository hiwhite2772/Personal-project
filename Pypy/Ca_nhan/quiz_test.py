questions = (
    "Should you use smoking to relax?",
...
# 1 trong những câu hỏi
for q in questions:
    print("-------------------")
    print(q)
    
    # 1 trong những câu lựa chọn đáp án cùng câu hỏi đó
    ...
    while True:
        ...
        # Kiểm tra có A, B, C, D hay không?
        if guess in ("A", "B", "C", "D"):
            break
        else:
            print("Vui lòng chỉ nhập A, B, C hoặc D!")

    # Người ta chọn câu đáp án thì thêm vào danh sách đã chọn đáp án đó
    guesses.append(guess)
    
    # Nếu kiểm tra trả lời đáp án đã chọn của người ta thì đúng hay sai?
...
# Điểm = (số câu đáp án đúng / Số câu hỏi) nhân 100
